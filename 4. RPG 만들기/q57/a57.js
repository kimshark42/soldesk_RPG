/*************************************************
 ...
 RPG v0.8.0 Update
 -전투 종료 후 경험치 획득 메세지 출력 ex) 불쌍한 토끼, 엠피스에게 경험치 100을 주고 죽었습니다
 -보상 추가, 몬스터 사냥시 돈도 획득하도록 변경되었습니다
 ...
 function displayCharactersInfo(){
  ...
  function endBattle(){
    if(player.currenthp > 0){
      ...
      dw(slime.name + "을 물리쳤다!" + "당신의 경험치가" + slime.exp + "만큼 올랐습니다" + slime.money + "안 을 획득하였습니다" );
      return false;
    } if(player.currenthp < 0){
      dw("이런...너무 강하잖아!");
      br();
      dw("당신은" + slime.name + "에게 패배했다!");
      return true;
    }
  }
